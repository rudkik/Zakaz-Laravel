                            ...
                            <tr>
                                <td>
                                    <p style="font-weight: bold; font-size: 26px; line-height: 31px; color: #323232; margin: 10px 0 20px;">
                                        Здравствуйте, {{$subscriber->user ? $subscriber->user->fio : ''}}! </p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p style="font-size: 16px; line-height: 24px; color: #333; margin: 0 0 70px;"> Хотим
                                        поделиться с вами замечательной новостью: </p>
                                </td>
                            </tr>
                            <tr>
                                <td id="news-body">{{$data->body}}</td>
                            </tr>
                            <tr>
                                <td>
                                    <p style="font-size: 16px; line-height: 24px;">
                                        <span style="color: #333;">Подробности</span>
                                        <a href="{{$data ? $data->link : ''}}" style="color: #3072C4;">Читайте здесь</a>.
                                    </p>
                                </td>
                            </tr>
                            </tbody>
                ...
                <tr>
                    <td>
                        <table width="100%" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="left">
                                    <p style="margin: 0">Для отмены от подписки перейдите по <a
                                            href="{{route('unsubscribe.destroy', ['token' => $subscriber->token, 'user_id' => $subscriber->user_id])}}"
                                            style="color: #3072C4; text-decoration: underline;">ссылке.</a></p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
